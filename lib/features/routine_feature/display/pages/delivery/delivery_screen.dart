    ...
    showDialog(
      ...
      builder: (context) => CustomAlertDialog(
        ...
        onTapSave: () async {
          ...
          if (totalizerDuLeftReading != null &&
              totalizerDuRightReading != null) {
            routineProvider.routines[index].endTotalizerDuLeft =
                totalizerDuLeftReading;
            routineProvider.routines[index].endTotalizerDuRight =
                totalizerDuRightReading;
            routineProvider.notifyDataChange();
            if (routineProvider.routines[index].quantity !=
                routineProvider.routines[index].endQuantity) {
              await calculateBill(
                      routineProvider, context, loginProvider, index)
                  .then((isSuccess) {
                for (AdditionCharge additionCharge
                    in routineProvider.routines[index].additionalChargesList ??
                        []) {
                  if (additionCharge.breakUpType == 'total_payable_bill') {
                    routineProvider.routines[index].endPrice =
                        additionCharge.value;
                    break;
                  }
                }
              ...
              routineProvider.routines[index].endPrice =
                  routineProvider.routines[index].price;
              Navigator.of(context).push(MaterialPageRoute(
